...
4. **Approve** generates the full funnel for that slot — LLM-written copy via
   the eleven-rung waterfall (template fallback) for the mailer, Meta/Google/
