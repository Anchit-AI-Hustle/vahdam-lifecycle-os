...
function renderFlagship(opts) {
  ...
  const footer = band(PAL.ink,
    `<div style="padding:28px 30px;text-align:center;font-family:${BF};font-size:12px;line-height:1.8;color:${PAL.cream};">VAHDAM&reg; USA · Vahdam Teas Global Inc.<br>Registered mailing address here<br><br>You are receiving this because you shopped with VAHDAM&reg;.<br><span style="color:${PAL.gold};font-weight:700;">Unsubscribe &nbsp;·&nbsp; Email preferences &nbsp;·&nbsp; Privacy Policy &nbsp;·&nbsp; Terms of Service</span></div>`);
