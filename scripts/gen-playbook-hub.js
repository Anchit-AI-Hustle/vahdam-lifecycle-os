...
'  table.grid-tbl th{background:var(--vahdam-green);color:var(--vahdam-cream);font-size:10.5px;text-transform:uppercase;letter-spacing:.06em;}',
...
(function(){
  ...
  btn.addEventListener('click', function(){
    ...
    if(synced.indexOf(safeUrl)!==-1){ status.textContent='Already synced.'; status.style.color='var(--vahdam-gold)'; return; }
    synced.push(safeUrl); status.textContent='Sync triggered.'; status.style.color='var(--vahdam-green)'; input.value='';
    ...
    var tick = document.createElement('span'); tick.style.color='var(--vahdam-green)'; tick.style.fontWeight='700'; tick.textContent='✓';
    var a = document.createElement('a'); a.className='code-out underline'; a.style.color='var(--vahdam-gold-ink)';
