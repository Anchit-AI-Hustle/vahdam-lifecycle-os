...
"<div class=\"grid gap-4 sm:grid-cols-2 lg:grid-cols-3 mt-4\">" + briefCards + "</div>"
  ...
  return page({ title: "Complete Market Study :: Vahdam Playbook", desc: "The full US coffee and functional-beverage D2C landscape study: sizing, benchmarks, region-tabbed competitor dashboard, cohorts, and regional spending.", prefix: "../", activeKey: "market-study", crumb: "Market Study", main: main, extraJS: JS_MARKET });
}
